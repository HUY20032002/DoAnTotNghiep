...
router.put("/update/:id", ProductVariantController.updateProductVariant);
...
router.patch("/restore/:id", ProductVariantController.restoreProductVariant);
router.get("/trash/:id", ProductVariantController.getAllProductsTrash);
