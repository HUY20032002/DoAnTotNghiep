...
const TrashManagerUser = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <h1 className="text-2xl font-bold mb-4">Người Dùng Đã Xóa</h1>
      <Link
              ...
              userList.map((user, index) => (
                <tr key={user._id} className="hover:bg-gray-50">
                  ...
                  <td className="py-2 px-4 border-b space-x-2">
                    <button
                      className="text-blue-600 border border-blue-600 px-4 py-2 rounded-md hover:bg-blue-500 hover:text-white transition duration-300"
                      onClick={() => handleRestore(user._id)}>
                      <i className="fas fa-trash-restore"></i>{" "}
                    </button>
                    <button
                      className="text-red-600 border border-red-600 px-4 py-2 rounded-md hover:bg-red-500 hover:text-white transition duration-300"
